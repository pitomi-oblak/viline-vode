...
<div class="main-content">
    ...
    if ($subscribers_number > 0) {
        ...
        ?>
        <p class="subscription-info"><span class="subscription-info-number"><?php echo $subscribers_number ?></span>
            subscriber<?php echo ($subscribers_number > 1) ? 's' : '' ?> on your list</p>
        ...
        <div class="subscription-actions">
            ...
            <a class="button" id="clear-list-button" href="<?php echo Core::get()->router->getPageUrl('clear-list') ?>">Clear
                list</a>
        </div>
        <?php
...
<div class="sidebar">
    ...
    <ul class="main-nav">
        ...
        <li>
            <a href="<?php echo Core::get()->router->getPageUrl('admin-settings') ?>"><i class="icon-tools"></i>Admin
                panel settings</a>
        </li>
        <li>
            <a href="<?php echo Core::get()->router->getPageUrl('email-settings') ?>"><i class="icon-email"></i>Email
                settings</a>
        </li>
        <li>
            <a href="<?php echo Core::get()->router->getPageUrl('template-settings') ?>"><i class="icon-pencil"></i>Template
                settings</a>
        </li>
    </ul>
